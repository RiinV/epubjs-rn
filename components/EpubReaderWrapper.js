...
var EpubReaderWrapper = function EpubReaderWrapper(_ref) {
  ...
  var _onReady = function _onReady(b) {
    ...
    console.log(
      ...
      b == null
        ? void 0
        : (_b$package = b.package) == null
        ? void 0
        : (_b$package$metadata = _b$package.metadata) == null
        ? void 0
        : _b$package$metadata.title,
    );
    onReady && onReady(b);
  };
  ...
  var _onError = function _onError(error) {
    var text =
      "Failed to initialize stream. Use useState and pass the state value to 'retryState'. Any change to it will try to reinitialize the view. Details: " +
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              streamer == null
                ? void 0
                : (_streamer$current = streamer.current) == null
                ? void 0
                : _streamer$current.kill();

              if (!aBook.current) {
                aBook.current = (0, _epubjs.default)(
                  _objectSpread(
                    {
                      replacements: 'none',
                    },
              ...
              type =
                aBook == null
                  ? void 0
                  : (_aBook$current = aBook.current) == null
                  ? void 0
                  : _aBook$current.determineType(url);
            ...
            case 14:
              ...
              return _regenerator.default.awrap(
                streamer == null
                  ? void 0
                  : (_streamer$current2 = streamer.current) == null
                  ? void 0
                  : _streamer$current2.start(),
              );
            ...
            case 17:
              ...
              return _regenerator.default.awrap(
                streamer == null
                  ? void 0
                  : (_streamer$current3 = streamer.current) == null
                  ? void 0
                  : _streamer$current3.get(url),
              );
  ...
  (0, _react.useEffect)(
    function () {
      ...
      return function () {
        ...
        streamer == null
          ? void 0
          : (_streamer$current4 = streamer.current) == null
          ? void 0
          : _streamer$current4.kill();
      };
    },
    [url, retryState],
  );
